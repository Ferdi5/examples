...
use App\Domains\Imports\DBasics\Actions\InvoiceImportAction;

final class ImportDBasicsInvoiceController extends Controller
{
    public function store(Request $request): ?RedirectResponse
    {
        ...
        try {
            Excel::import(
                new InvoiceImportAction($administration->id, $customerNumber, $fileName),
                $file,
                null,
